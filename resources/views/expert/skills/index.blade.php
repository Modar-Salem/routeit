                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header d-flex justify-content-between align-items-center">
                                <h4 class="box-title">RoadMap Skills Information</h4>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-row">
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="{{ route('expert.skills.show', $skill) }}" type="button" class="btn btn-primary ml-3">Add Video OR Blogs &rarr;</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
